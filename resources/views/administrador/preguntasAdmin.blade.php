                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-8"><h2><b>Preguntas Frecuentes</b></h2></div>
                                </div>
                            </div>
                            <a class="button" href="/administrador/agregarPreguntas">+ Agregar un Pregunta</a>
                            ...
                            <thead>
                                ...
                                @php 
                                    $counter2 = 1;
                                @endphp                                
                                @foreach($lista as $preguntasFrecuentes)
                                    <tr>
                                        ...
                                        @endphp
                                        <td class = text-center>{{$preguntasFrecuentes->pregunta}}</td>
                                        <td class = text-center>{{$preguntasFrecuentes->respuesta}}</td>
                                        <td class = text-center>{{$preguntasFrecuentes->emitido}}</td>
                                    <td class = text-center>
                                            <a href= "{{url ('/administrador/editarPreguntas', $preguntasFrecuentes)}}" class="edit" title="Edit" data-toggle="tooltip">
                                                <i class="material-icons"style="color:#2A4858">edit</i>
                                            </a>
                                            <a href="{{url ('/administrador/borrarPreguntas', $preguntasFrecuentes)}}" class="delete" title="Delete" data-toggle="tooltip">
