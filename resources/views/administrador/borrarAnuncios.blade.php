        ...
        <div class="content-wrapper" style="background-color:#D9D9D9; padding: 20px;">
            <div class="container-xl">
                <div class="table-title">
                     <div class="row">
                            <div class="col-sm-8"><h2><b>Eliminar Anuncio</b></h2></div>
                     </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">¿Esta seguro de eliminar este Anuncio?</h3>
                                </div>
                            <form action="{{url ('/deleteAnuncio', $anuncio->id)}}" method="POST" role="form">
                                    @csrf
                                    @method('delete')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="comunicado" name="comunicado" value="{{$anuncio->comunicado}}" disabled>
                                    </div>
                                    <div class="form-group">
