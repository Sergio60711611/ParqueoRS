...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    @include('administrador.navbar')
                ...
                <div class="tituloc">
                    <h1><strong> Editar Horario</strong></h1>
                </div>
      <div class=" titulob">
      ...
      <div class="formulario">
            ...
            <div class="horaa">
                ...
                <input type="time" class="choraa" name="hora_inicio" placeholder="Ingrese la hora de apertura de apertura" value="{{$horario->hora_inicio}}"></input>
                @error('hora_inicio')
                <p1 class="error-message">{{ $message }}</p1>
                @enderror
            </div>
            <div class="horac">
                ...
                <input type="time" class="chorac" name="hora_fin" placeholder="Ingrese la hora de cierre" value="{{$horario->hora_fin}}"></input>
                @error('hora_fin')
                <p1 class="error-message">{{ $message }}</p1>
                @enderror
            </div>
