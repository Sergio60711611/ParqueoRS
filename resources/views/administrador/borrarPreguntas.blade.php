        ...
        <div class="content-wrapper" style="background-color:#D9D9D9; padding: 20px;">
            <div class="container-xl">
                <div class="table-title">
                     <div class="row">
                            <div class="col-sm-8"><h2><b>Eliminar Pregunta</b></h2></div>
                     </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">¿Esta seguro de eliminar esta Pregunta?</h3>
                                </div>
                            <form action="{{url ('/deletePregunta', $preguntasFrecuentes->id)}}" method="POST" role="form">
                                    @csrf
                                    @method('delete')
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="">Titulo</label>
                                        <input type="text" class="form-control" id="pregunta" name="pregunta" value="{{$preguntasFrecuentes->pregunta}}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Respuesta</label>
                                        <input type="text" class="form-control" id="respuesta" name="respuesta" value="{{$preguntasFrecuentes->respuesta}}" disabled>
                                    </div>
                                    <div class="form-group">
