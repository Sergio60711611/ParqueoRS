                ...
                <div class="container-xl">
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            ...
                            <form  class = "formualrio1" action="/administrador/clientesnologueados" method="get">
                            <input type="text" class="cajab" name="texto" style="width:35%" placeholder="Ingrese nombre o apellido o carnet">
                            ...
                            <thead>
                                ...
                                @foreach($lista as $clientesnologueados)
                                    <tr>
                                        <td class = text-center>{{$counter}}</td>
                                        @php 
                                            $counter=$counter +1;
                                        @endphp
                                        <td class = text-center>{{$clientesnologueados->nombre}}</td>
                                        <td class = text-center>{{$clientesnologueados->apellido}}</td>
                                        <td class = text-center>{{$clientesnologueados->ci}}</td>
                                        <td class = text-center>{{$clientesnologueados->placa}}</td>
                                    </tr>
                                    @endforeach
