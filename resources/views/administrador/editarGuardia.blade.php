...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    @include('administrador.navbar')
                ...
                <div class="borde-formulario">
                    ...
                    <h2 class="tituloa"><strong>Editar Guardia</strong></h2>
               
                <!-- borde 2-->
                <div class ="borde2-formulario">    
                        <h4 class="titulob">Datos del Guardia</h4>
                    <!--Formulario-->
                        <form class="formulario" action="{{url ('/guardia', $guardia->id)}}" method="Post" role="form">
                                @csrf
                                @method('put')
                                <label class = "nombres" for="">Nombres<font color="red">*</font></label>
                                
                                <input type="text" class="cnombre" name="nombre" placeholder="Ingrese su(s) nombre(s)" value="{{$guardia->nombre}}"></input>
                                @error('Nombres')
                                ...
                                <input type="text" class="capellido" name="apellido" placeholder="Ingrese su(s) apellido(s)" value="{{$guardia->apellido}}"></input>
                                @error('Apellidos')
                                <p1 class="error-message">{{ $message }}</p1>
                                @enderror
                                ...
                                <input type="text" class="cci" name="ci" placeholder="Ingrese su carnet de identidad" value="{{$guardia->ci}}"></input>
                                @error('CI')
                                <p1 class="error-message">{{ $message }}</p1>
                                @enderror
                                ...
                                <input type="email" class="ccorreo" name="correo_electronico" placeholder="Ingrese su correo electrónico" value="{{$guardia->correo_electronico}}"></input>
                                @error('Correo')
                                <p1 class="error-message">{{ $message }}</p1>
                                @enderror
                                ...
                                <input type="password" class="ccontraseña" id = "ccontraseña" name="password" placeholder="Ingrese la contraseña" value="{{$guardia->password}}"></input>
                                ...
                                <input type="number" class="ccelular" name="celular" placeholder="Ingrese su número de celular" value="{{$guardia->celular}}"></input>
                                @error('CI')
                                <p1 class="error-message">{{ $message }}</p1>
                                @enderror
                                </div>
                                ...
                                <select class="cturnos" name="cturnos" id="cturnos" required >
                                    <option value="{{$guardia->turno}}">{{$guardia->turno}}</option>
                                    <option><strong>Mañana(Lunes-Viernes)</strong>  (08:00 AM - 02:00 PM)</option>
                                    <option><strong>Noche(Lunes-Viernes)</strong>  (02:00 PM - 10:00 PM)</option>
                                ...
                                <input type="date" class="cfechai" name="fecha_inicio" placeholder="Ingrese la fecha de inicio" value="{{$guardia->fecha_inicio}}"></input>
                                @error('fecha_inicio')
                                <p1 class="error-message">{{ $message }}</p1>
                                @enderror
                                ...
                                <input type="date" class="cfechaf" name="fecha_fin" placeholder="Ingrese la fecha de conclusión" value="{{$guardia->fecha_fin}}"></input>
                                @error('fecha_fin')
                                <p1 class="error-message">{{ $message }}</p1>
                                @enderror
-->
                            <input type="hidden" class ="cidpar" name="id_parqueo" value="1"></input>
                            <button type="submit"  class="botong">Actualizar</button>
